...
class Party implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const PARTY_ID_TYPE_MSISDN = 'MSISDN';
    public const PARTY_ID_TYPE_EMAIL = 'EMAIL';
    public const PARTY_ID_TYPE_PARTY_CODE = 'PARTY_CODE';
     ...
     * @return string[]
     */
    public function getPartyIdTypeAllowableValues()
    {
        return [
            self::PARTY_ID_TYPE_MSISDN,
            self::PARTY_ID_TYPE_EMAIL,
            self::PARTY_ID_TYPE_PARTY_CODE,
        ];
    }
    ...
    {
        $this->setIfExists('party_id_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getPartyIdTypeAllowableValues();
        if (!is_null($this->container['party_id_type']) && !in_array($this->container['party_id_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'party_id_type', must be one of '%s'",
                $this->container['party_id_type'],
    ...
    {
        return $this->container['party_id_type'];
    }

    /**
     * Sets party_id_type
     *
     * @param string|null $party_id_type party_id_type
     *
     * @return self
     */
    public function setPartyIdType($party_id_type)
    {
        if (is_null($party_id_type)) {
            throw new \InvalidArgumentException('non-nullable party_id_type cannot be null');
        }
        $allowedValues = $this->getPartyIdTypeAllowableValues();
        if (!in_array($party_id_type, $allowedValues, true)) {
        ...
        $this->container['party_id_type'] = $party_id_type;
