...
namespace Mtn\Momo\Disbursement;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://sandbox.momodeveloper.mtn.com/disbursement';
    ...
    {
        $report  = 'PHP SDK (Mtn\Momo\Disbursement) Debug Report:' . PHP_EOL;
